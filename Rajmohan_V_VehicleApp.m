function varargout = Rajmohan_V_VehicleApp(varargin)
% RAJMOHAN_V_VEHICLEAPP MATLAB code for Rajmohan_V_VehicleApp.fig
%      RAJMOHAN_V_VEHICLEAPP, by itself, creates a new RAJMOHAN_V_VEHICLEAPP or raises the existing
%      singleton*.
%
%      H = RAJMOHAN_V_VEHICLEAPP returns the handle to a new RAJMOHAN_V_VEHICLEAPP or the handle to
%      the existing singleton*.
%
%      RAJMOHAN_V_VEHICLEAPP('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in RAJMOHAN_V_VEHICLEAPP.M with the given input arguments.
%
%      RAJMOHAN_V_VEHICLEAPP('Property','Value',...) creates a new RAJMOHAN_V_VEHICLEAPP or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before Rajmohan_V_VehicleApp_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to Rajmohan_V_VehicleApp_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help Rajmohan_V_VehicleApp

% Last Modified by GUIDE v2.5 17-Oct-2021 20:03:24

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @Rajmohan_V_VehicleApp_OpeningFcn, ...
                   'gui_OutputFcn',  @Rajmohan_V_VehicleApp_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before Rajmohan_V_VehicleApp is made visible.
function Rajmohan_V_VehicleApp_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to Rajmohan_V_VehicleApp (see VARARGIN)

% Choose default command line output for Rajmohan_V_VehicleApp
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes Rajmohan_V_VehicleApp wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = Rajmohan_V_VehicleApp_OutputFcn(hObject, eventdata, handles) 
...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
% % % @(hObject,eventdata)Rajmohan_V_VehicleApp('uitable1_CreateFcn',hObject,eventdata,guidata(hObject))
